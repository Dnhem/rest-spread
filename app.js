...
//Refactored with rest and arrow function
...
const doubleAndReturnArgs = (arr, ...args) => {
	const dblArgs = args.map((num) => num * 2);
	return [ arr, ...dblArgs ];
};
...
//I thought I wouldn't be able to run the map method inside the array literal brackets
//Now I know you absolutely can
